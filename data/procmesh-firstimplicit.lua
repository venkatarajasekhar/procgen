	...
	for z=-r,r-1 do
		for y=-r,r-1 do
			for x=-r,r-1 do
				...
				if xyz == 1+4+8 or xyz == 255-(1+4+8) then
					AddQuad( mxyz,myXz,mzxy,mzXY, n, uv1,uv2,uv3,uv4 )
					AddTri( mzXY,mzxy,mzxY, n, uv1,uv2,uv3 )
				end
				if xyz == 2+4+8 or xyz == 255-(1+4+8) then
					AddQuad( mxyz,myxz,mzXy,mzxY, n, uv1,uv2,uv3,uv4 )
					AddTri( mzxY,mzXy,mzXY, n, uv1,uv2,uv3 )
				end

				if xyz == 16+32+64 or xyz == 255-(16+32+64) then
					AddQuad( mxYZ,myXZ,mzxY,mzXy, n, uv1,uv2,uv3,uv4 )
					AddTri( mzxY,mzXy,mzxy, n, uv1,uv2,uv3 )
				end
				if xyz == 16+32+128 or xyz == 255-(16+32+128) then
					AddQuad( mxYZ,myxZ,mzXY,mzxy, n, uv1,uv2,uv3,uv4 )
					AddTri( mzXY,mzxy,mzXy, n, uv1,uv2,uv3 )
				end
				if xyz == 16+64+128 or xyz == 255-(16+64+128) then
					AddQuad( mxyZ,myXZ,mzxy,mzXY, n, uv1,uv2,uv3,uv4 )
					AddTri( mzxy,mzXY,mzxY, n, uv1,uv2,uv3 )
				end
				if xyz == 32+64+128 or xyz == 255-(32+64+128) then
					AddQuad( mxyZ,myxZ,mzXy,mzxY, n, uv1,uv2,uv3,uv4 )
					AddTri( mzXy,mzxY,mzXY, n, uv1,uv2,uv3 )
				end
			end
