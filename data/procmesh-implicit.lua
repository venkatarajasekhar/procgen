		...
		for y=-r,r-1 do
			for x=-r,r-1 do
				...
				if numtris  > 0 then
					...
					mxyz={x+(xmid[index]or 0.5),y+0,z+0}
					mxYz={x+(xmid[index+r2]or 0.5),y+D,z+0}
					mxyZ={x+(xmid[index+r22]or 0.5),y+0,z+D}
					mxYZ={x+(xmid[index+r2+r22]or 0),y+D,z+D}
					myxz={x+0,y+(ymid[index]or 0.5),z+0}
					myXz={x+D,y+(ymid[index+1]or 0.5),z+0}
					myxZ={x+0,y+(ymid[index+r22]or 0.5),z+D}
					myXZ={x+D,y+(ymid[index+1+r22]or 0.5),z+D}
					mzxy={x+0,y+0,z+(zmid[index]or 0.5)}
					mzXy={x+D,y+0,z+(zmid[index+1]or 0.5)}
					mzxY={x+0,y+D,z+(zmid[index+r2]or 0.5)}
					mzXY={x+D,y+D,z+(zmid[index+1+r2]or 0.5)}
					...
					for t=1,numtris do
						...
						v2 = vertlist[1+v2]
						v3 = vertlist[1+v3]
						Log("V1 "..v1[1].." "..v1[2].." "..v1[3])
						Log("V2 "..v2[1].." "..v2[2].." "..v2[3])
						Log("V3 "..v3[1].." "..v3[2].." "..v3[3])
